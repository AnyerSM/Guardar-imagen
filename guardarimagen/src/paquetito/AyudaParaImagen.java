...
public class AyudaParaImagen extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFileChooser selector =new JFileChooser(); //abre
            selector.showOpenDialog(this);//muestra
           File file= selector.getSelectedFile();//selecciona imagen
           try{
           FileInputStream fis=new FileInputStream(file);
           byte[]datosImagen=IOUtils.toByteArray(fis);
           Galeria g1=new Galeria();
           g1.setDatosImagen(datosImagen);
           g1.setDescripcion("Pueblo");
           g1.setTitulo("villa");
